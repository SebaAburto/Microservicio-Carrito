...
import com.carrito.carrito.assembler.UsuarioModelAssembler;
import com.carrito.carrito.model.Usuario;
import com.carrito.carrito.Service.UsuarioService;
...
public class UsuarioControllerV2 {
    ...
    public EntityModel<Usuario> buscar(@PathVariable Long id) throws Exception {
    ...
    public ResponseEntity<EntityModel<Usuario>> actualizar(@PathVariable Long id, @RequestBody Usuario usuario) throws Exception {
